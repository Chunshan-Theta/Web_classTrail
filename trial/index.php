	...
	<body>
		...
		<div id="content" style="margin:auto;padding:80px;border-radius:100px;background-color:#77AAFF;width:750px;">
            <form method='POST' action='indexteacher.php'>
                <p>教師姓名<input for="teacherN" name='teacherN'  type="text" style="margin-left:10px;margin-right:5px;"></input><input type='submit' value='送出' name='insert'/></input><p>
            </form>
            <form method='POST' action='indexclass.php'>
                <p>課程名稱<input for="classN" name='classN'  type="text" style="margin-left:10px;margin-right:5px;"></input><input type='submit' value='送出' name='insert'/></input><p>
            </form>
            <form method='POST' action='indexmajor.php'>
                <p>開設系別<input for="major" name='major'  type="text" style="margin-left:10px;margin-right:5px;"></input><input type='submit' value='送出' name='insert'/></input><p>
            </form>
            <form method='POST' action='indexmajor.php'>
            </form>
            <form method='POST' action='indexteacher.php'>
